...
if __name__ == "__main__":
    ...
    parser.add_argument('--encoder_path', dest='encoder_path', type=str, default="", help='the name of encoder')
    parser.add_argument('--decoder_path', dest='decoder_path', type=str, default="", help='the name of decoder')
    ...
    if args.eval_type == 'val':
        ...
        btest_submission(path_type, max_episode_len, history, MAX_INPUT_LENGTH, feedback_method, n_iters, model_prefix, blind, args)
