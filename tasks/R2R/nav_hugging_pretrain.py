...
def train(args, train_dataset, model, tokenizer):
    ...
    for epo in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            outputs = model(inputs, attention_mask=lang_attention_mask,masked_lm_labels=labels) if args.mlm else model(inputs, labels=labels)
...
def main():
    ...
    parser.add_argument("--dropout_ratio", default=0.1, type=float,help="dropout ratio")
    ...
    config.attention_probs_dropout_prob = args.dropout_ratio
    config.hidden_dropout_prob = args.dropout_ratio
