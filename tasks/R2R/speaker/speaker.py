...
class Seq2SeqSpeaker(object):
    ...
    def __init__(self, env, results_path, encoder, decoder, seed, instruction_len, max_episode_len=10):
        self.env = env
    ...
    def _batch_observations_and_actions(self, path_obs, path_actions, encoded_instructions):
        ...
        feature_list = [path_obs[0][0]['feature'][0]]
    ...
    def _score_obs_actions_and_instructions(self, path_obs, path_actions, encoded_instructions, feedback):
        ...
        instr_seq, _, _ = batch_instructions_from_encoded(encoded_instructions, self.instruction_len, reverse=True)
